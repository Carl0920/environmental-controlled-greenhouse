    ...
    <table class="styled-table" id= "table_id">
      <thead>
        <tr>
          ...
          <th>HUMIDITY1 (%)</th>
          <th>STATUS READ SENSOR DHT1</th>
          <th>TEMPERATURE2 (°C)</th>
          <th>HUMIDITY2 (%)</th>
          <th>STATUS READ SENSOR DHT2</th>
          <th>TEMPERATURE3 (°C)</th>
          <th>HUMIDITY3 (%)</th>
          <th>STATUS READ SENSOR DHT3</th>
          <th>TEMPERATURE4 (°C)</th>
          <th>HUMIDITY4 (%)</th>
          <th>STATUS READ SENSOR DHT4</th>
          <th>CO2 1</th>
          <th>STATUS READ SENSOR MQ135 1</th>
          <th>CO2 2</th>
          <th>STATUS READ SENSOR MQ135 2</th>
          <th>TIME</th>
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          foreach ($pdo->query($sql) as $row) {
            ...
            echo '<td class="bdr">'. $row['humidity1'] . '</td>';
            echo '<td class="bdr">'. $row['status_read_sensor_dht1'] . '</td>';
            echo '<td class="bdr">'. $row['temperature2'] . '</td>';
            echo '<td class="bdr">'. $row['humidity2'] . '</td>';
            echo '<td class="bdr">'. $row['status_read_sensor_dht2'] . '</td>';
            echo '<td class="bdr">'. $row['temperature3'] . '</td>';
            echo '<td class="bdr">'. $row['humidity3'] . '</td>';
            echo '<td class="bdr">'. $row['status_read_sensor_dht3'] . '</td>';
            echo '<td class="bdr">'. $row['temperature4'] . '</td>';
            echo '<td class="bdr">'. $row['humidity4'] . '</td>';
            echo '<td class="bdr">'. $row['status_read_sensor_dht4'] . '</td>';
            echo '<td class="bdr">'. $row['co21'] . '</td>';
            echo '<td class="bdr">'. $row['status_read_MQ135_1'] . '</td>';
            echo '<td class="bdr">'. $row['co22'] . '</td>';
            echo '<td class="bdr">'. $row['status_read_MQ135_2'] . '</td>';
